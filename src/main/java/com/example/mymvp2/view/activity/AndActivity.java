...
import com.example.mymvp2.persenter.ButtonUtils;
import com.example.mymvp2.persenter.Getitem;
import com.example.mymvp2.persenter.MyGridView;
import com.example.mymvp2.persenter.OtherAdapter;
...
public class AndActivity extends Activity implements AdapterView.OnItemClickListener {
   ...
   // private List<String> mUserList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.andactivity);
        initView();
        getnote();
    }
    public void getnote() {
...
//        mUserList.add("网络");
        ...
        mOtherList.add("娱乐");
        mOtherList.add("探索");
        mUserAdapter = new OtherAdapter(this, listtitle,true);
    ...
    public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
        switch (parent.getId()) {
            case R.id.userGridView:
                if(!ButtonUtils.isFastDoubleClick(R.id.userGridView)){
